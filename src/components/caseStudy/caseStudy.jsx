...
function CaseStudy() {
  ...
  const data = [
    ...
    },
    {
      name: "Storilabs",
      gridImages: [
        "storilabs-grid-1.webp",
        "storilabs-grid-2.webp",
        "storilabs-grid-3.webp",
      ],
      projectIntroduction: [
        "Storilabs was built as a modern marketing website designed to clearly communicate the brand’s value while delivering a smooth, distraction-free user experience. The project focused on balancing strong visual identity with technical performance, ensuring the site feels lightweight, responsive, and intentional across all devices.",
      ],
      projectApproach: [
        "Rather than starting with visuals alone, the build began with content flow and user intent. Each section was structured to guide users naturally through the site, using semantic HTML to support accessibility and long-term maintainability.",
        "The styling layer was crafted with CSS to create a restrained, professional aesthetic that aligns with the Storilabs brand. Layouts were designed mobile-first, with careful attention to spacing, typography, and responsiveness. React was used selectively to enhance interactions and transitions, keeping the experience smooth without compromising load performance.",
      ],
      projectOutcome: [
        "The final site delivers a clean, fast, and cohesive front-end experience that reinforces the Storilabs brand. It loads quickly, adapts effortlessly across screen sizes, and provides subtle interactivity that supports the content. The project demonstrates my ability to translate brand requirements into a well-executed, production-ready front-end build.",
      ],
      displayImage: "storilabs-display-img.webp",
      closingImg: "",
      displayImageMobile: "storilabs-display-img.webp",
      closingImgMobile: "",
      languagesUsed: ["HTML", "CSS", "React"],
      projectUrl: "https://storilabs.ai/",
      metaDescription:
        "Storilabs is a performance-focused marketing website built with HTML, CSS, and React. This case study explores the front-end decisions behind creating a fast, accessible, and visually refined experience designed to support a growing digital brand.",
      slug: "storilabs",
      canonicalTag: "https://storilabs.ai/",
    },
  ];
    ...
    <div className="case-study">
      <Helmet>
        {study
          ? [
              <title key="title">
                {study.name} Case Study | Matthew's Frontend Developer Portfolio
              </title>,
              <link rel="canonical" href={study.canonicalTag} />,
              <meta
                key="meta"
                name="description"
              ...
              <meta
                ...
                content={study.metaDescription}
              />,
              <meta key="og-image" property="og:image" content="here" />,
              <meta
                key="og-url"
                property="og:url"
          ...
          : [<title>Matthew Heiberg | Frontend Developer Portfolio</title>]}
      </Helmet>
      {study ? (
        <>
            ...
            <div className="case-study-content-header-link">
              <div className="case-study-pills">
                <div className="case-study-projects-tags">
                  {study.languagesUsed.map((tag, tagIndex) => (
          ...
          <section className="case-study-content">
            ...
            {study.projectIntroduction.length > 0 &&
              study.projectIntroduction.map((item, index) => (
                <p
